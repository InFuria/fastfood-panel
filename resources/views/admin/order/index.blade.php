...
<div class="row">
<div class="col-md-12" style="text-align: right;"><a href="{{ Asset(env('admin').'/order/add') }}" class="btn m-b-15 ml-2 mr-2 btn-rounded btn-warning">Agregar nuevo</a>&nbsp;&nbsp;&nbsp;</div>
